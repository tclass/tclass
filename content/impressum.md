...
# Disclaimer
just that everybody gets it, I don't have any Google Analytics or Facebook plugin running. So the site doesn't 
collect any data, except server logs, but that's a little bit hard to turn off right. So you can just surf around
here and read the articles, if you have questions or want to contact me in any way. Just write me an email: `t dot klasse at gmail.de`
if you want the same stuff in proper law-german, feel free to read further.
...
<td></td></tr>
<tr><td>E-Mail:</td>
<td>`t punkt klasse ät gmail punkt com`</td>
</tr></table>
<p> </p>
